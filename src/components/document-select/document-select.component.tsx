...
export const DocumentSelect = () => {
  ...
  return (
    <div className='  justify-start items-center gap-6 inline-flex'>
      <div className=' self-stretch p-4 bg-white rounded-lg border border-gray-300 flex-col justify-start items-start gap-3 inline-flex'>
        ...
        <div className='self-stretch h-56 flex-col justify-start items-start gap-3 flex'>
          ...
          <div className='self-stretch justify-start items-start gap-3 inline-flex'>
            <div className='grow shrink basis-0 h-9 px-2.5 py-2 bg-white rounded-lg border border-gray-300 flex-col justify-between items-start inline-flex'>
              <select name='Subsidory' id='Subsidory'>
      ...
      <div className='w-full self-stretch p-4 bg-white rounded-lg border border-gray-300 flex-col justify-start items-start gap-3 inline-flex'>
        <SelectedDocument />
      </div>
    </div>
  )
